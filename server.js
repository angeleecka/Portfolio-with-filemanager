...
// ─────────────────────────────────────────────────────────────
// Watcher: авто-регенерация data/portfolio.json при изменениях в uploads
//let genTimer = null;
/*function scheduleGenerate(reason = "") {
  ...
  genTimer = setTimeout(async () => {
    ...
    try {
      ...
      console.error("Error while regenerating portfolio.json:", err);
    }
  }, 300); // легкий debounce, чтобы не дергать генератор слишком часто
}*/
